            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="flex h-20 items-center justify-between">
                    ...
                    {open ? (
                        ...
                        <div id="menu" className="flex flex-col my-10 justify-start space-y-6 font-bold left-2 right-2 ">
                            <NavLink to="/" className={linkClass} onClick={handleNavLinkClick}>Home</NavLink>
                            <NavLink to="/jobs" className={linkClass} onClick={handleNavLinkClick}>Jobs</NavLink>
                            <NavLink to="/add-jobs" className={linkClass} onClick={handleNavLinkClick}>Add Jobs</NavLink>
                        </div>
                    </div>
                    ) : '' }
